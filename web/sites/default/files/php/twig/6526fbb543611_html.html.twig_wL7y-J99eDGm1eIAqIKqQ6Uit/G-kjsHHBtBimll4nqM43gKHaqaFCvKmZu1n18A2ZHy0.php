...
class __TwigTemplate_7ab54369c4faae92b37ea22cfd492001 extends Template
{
    private $source;
    private $macros = [];
...
($context["logged_in"] ?? null)) ? ("user-logged-in") : ("user-guest")), 1 => (( !        // line 30
($context["root_path"] ?? null)) ? ("frontpage") : (("inner-page path-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["root_path"] ?? null), 30, $this->source))))), 2 => ((        // line 31
