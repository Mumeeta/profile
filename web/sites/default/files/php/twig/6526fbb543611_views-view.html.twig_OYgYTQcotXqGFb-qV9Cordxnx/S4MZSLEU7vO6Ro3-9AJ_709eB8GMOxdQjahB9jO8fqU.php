...
class __TwigTemplate_0bb365825084e027319b0a626da612aa extends Template
{
    private $source;
    private $macros = [];
...
($context["id"] ?? null), 36, $this->source))), 2 => ("view-display-" . $this->sandbox->ensureToStringAllowed(        // line 37
